...
namespace Zicht\Bundle\TinymceBundle\DependencyInjection;
...
/**
 * Class ZichtTinymceExtension.
 */
class ZichtTinymceExtension extends Extension
{
    /**
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('zicht_tinymce.config', $config);
